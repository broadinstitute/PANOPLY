...
option_list <- list(
  ...
  make_option( c("-l", "--level"), action='store', type='character',  dest='level', help="Mode of report, 'ssc','gc', 'gcr'.", default='ssc'),
  ...
  make_option( c("-u", "--use_as_is"), action='store', type='logical',  dest='use.as.is', help='If TRUE nothing will be done; probably needed for to make this step optional in a FireCLoud WDL.', default = FALSE),
