...
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_main_internal/versions/2/plain-WDL/descriptor" as panoply_main_internal
## Proteogenomic
...
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_rna_protein_correlation_report/versions/18/plain-WDL/descriptor" as rna_corr_report_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_cna_setup/versions/21/plain-WDL/descriptor" as cna_setup_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_cna_correlation/versions/16/plain-WDL/descriptor" as cna_corr_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_cna_correlation_report/versions/20/plain-WDL/descriptor" as cna_corr_report_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_cmap_analysis/versions/20/plain-WDL/descriptor" as cmap_wdl
## Sample-QC
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_sampleqc/versions/19/plain-WDL/descriptor" as sampleqc_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_sampleqc_report/versions/19/plain-WDL/descriptor" as sampleqc_report_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_cosmo/versions/6/plain-WDL/descriptor" as cosmo_wdl
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_omicsev/versions/6/plain-WDL/descriptor" as omicsev_wdl
## Support
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptac:panoply_download/versions/19/plain-WDL/descriptor" as download_wdl
