...
## Usage: Rscript cmap-annotate.R tar_file cmap_data_file group data_type enrichment_groups_file
##                                alpha cna_threshold log_transform
...
cna.threshold <- as.numeric (args[7])
log.transform <- ifelse (args[8]=="TRUE", TRUE, FALSE)
