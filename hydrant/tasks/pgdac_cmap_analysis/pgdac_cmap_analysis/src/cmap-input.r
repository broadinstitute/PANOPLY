...
## Usage:
## Rscript cmap-input.r <cna-dir> <kd-gene-list> <group> <dtype> <nperm> <config-file>
...
must.include.genes <- NULL         # genes that must be include in the CMAP analysis (vector, default: NULL)
