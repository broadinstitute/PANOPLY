...
import "https://api.firecloud.org/ga4gh/v1/tools/broadcptacdev:panoply_so_nmf_report/versions/3/plain-WDL/descriptor" as so_nmf_report_wdl
...
workflow panoply_so_nmf_sankey_workflow {
  ...
  call so_nmf_report_wdl.panoply_so_nmf_report as nmf_sankey_report {
    input:
      so_nmf_tar = so_nmf_tar,
      mo_nmf_tar = mo_nmf_tar,
