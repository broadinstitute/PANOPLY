...
option_list <- list(
  ...
  make_option( c("-v", "--var"), action='store', type='numeric',  dest='var_pca_expl', help='explained variance by PCA', default = 0.9),
  make_option( c("-t", "--tol"), action='store', type='numeric',  dest='perc_tol', help='Stop tolerance to end optimization as fraction of total variance.', default = 0.05),
...
## - used to extract the n PsC explaining 'var_pca_expl' of
